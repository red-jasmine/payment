    ...
    public function up() : void
    {
        Schema::create(config('red-jasmine-payment.tables.prefix', 'jasmine_').'payment_transfers',
            function (Blueprint $table) {
                ...
                // 收款方
                $table->string('payee_type')->nullable()->comment('收款方类型');
                $table->string('payee_identity_id')->nullable()->comment('收款方类型');
                $table->string('payee_identity_type')->nullable()->comment('收款方类型');
                ...
                $table->string('remark')->comment('转账备注');
